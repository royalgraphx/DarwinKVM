...
<p align="center">
  <img width="650" height="200" src="../../../../assets/Headers/Header-NVRAM.png">
</p>

<a href=""><img src="../../../../assets/OpenCore/OpenCoreNVRAM.png" alt=""></a>
...
| ``-nehalem_error_disable`` | This disables AppleTyMCEDriver so the non ECC virtual RAM of Q35 on MacPro5,1 / MacPro4,1 does not cause a kernel panic for not being ECC. |
