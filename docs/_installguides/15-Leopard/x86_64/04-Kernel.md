...
| ----- | ----- | ----- |
| DisableLinkeditJettison | False | Enables __LINKEDIT jettison code. |
...
| FuzzyMatch | Boolean | True | Improves Mac OS X 10.6 (Snow Leopard) booting times by utilizing a different algorithm, if you don't care about ancient macOS/Mac OS X versions, disable this. |
| KernelArch | String | Auto | This setting will use the specified architecture to boot macOS when it is supported by the macOS in question. |
