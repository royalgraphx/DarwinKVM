...
To begin, confirm you have downloaded the correct Install Disks for Tiger.
...
```xml
<qemu:arg value='-drive'/>
<qemu:arg value='if=none,format=raw,media=disk,id=Installer,file=/home/user/DarwinKVM/DarwinFetch/downloads/10.4.8_8L127/Mac OS X 10.4.8/Mac OS X 10.4.8.iso,discard=unmap,detect-zeroes=unmap'/>
```

In this example, we point to the OS X 10.4.8 ISO Install Media from DarwinFetch.
