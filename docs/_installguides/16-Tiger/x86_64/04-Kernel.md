...
Needed for spoofing unsupported CPUs like Pentiums and Celerons. We'll activate DummyPowerManagement.
...
| LegacyCommpage | True | Replaces the default 64-bit commpage bcopy implementation with one that does not require SSSE3, useful for legacy platforms. |
